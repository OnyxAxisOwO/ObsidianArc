...
//
// Hand-rolled rather than a library, for the same reason everything else here
// is: this is forty lines and no dependency, and a confetti package is
// several kilobytes to draw a thing that falls down.

...
| Frontend | 59 kB gzipped to open the chat — 47 kB of JavaScript and 12 kB of CSS. The Chinese dictionary (12 kB), the backoffice (18 kB) and the formula renderer (4 kB) are separate, and are fetched only by the people who need them |

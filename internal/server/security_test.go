...
func TestAdminRoutesRequireAnAdministrator(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodGet, "/api/admin/mail", nil},
		{http.MethodPut, "/api/admin/mail", map[string]any{"host": "smtp.example.com"}},
		{http.MethodPost, "/api/admin/mail/test", map[string]any{"to": "admin@example.com"}},
		{http.MethodGet, "/api/admin/usercheck", nil},
		{http.MethodPut, "/api/admin/usercheck", map[string]any{"enabled": false}},
		{http.MethodPost, "/api/admin/usercheck/test", map[string]any{"email": "admin@example.com"}},
...
func TestUserRoutesRequireASession(t *testing.T) {
	...
	routes := []struct {
		...
		{http.MethodPost, "/api/profile/verify/code", map[string]any{"code": "123456"}},
